...
from apps.reports.views import pdf_view

from apps.reports.views import Student_ListView, Teacher_ListView, Subscription_ListView, SubscriptionTypes_ListView, Lesson_ListView, LessonTypes_ListView, User_ListView, Payment_ListView
