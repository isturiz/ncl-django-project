...
from .views import StudentListView, StudentAddView, StudentUpdateView, StudentIsActiveView
...
urlpatterns = [
    ...
    path('students/<int:pk>/is-active/', StudentIsActiveView.as_view(), name='student-is-active'),
